...
st.markdown("<h1 style='text-align: center;'>Cris blog</h1>", unsafe_allow_html=True)
...
texto = """
Hola, soy Cristel, tengo veinte años y actualmente curso el quinto ciclo de la universidad. En mi tiempo libre, me gusta escuchar música, ver películas y series, y leer. Además, soy cachimba en la facultad y estudio Comunicación para el Desarrollo. Lo que más me gusta de mi carrera es el enfoque social que tiene, pues se encarga de buscar posibles soluciones para distintas problemáticas existentes en la sociedad. Buscamos hacer cumplir las políticas públicas que muchas veces no se llevan a cabo debido a una mala gestión por parte del Estado. Asimismo, me gusta que, mediante mi carrera, podré tener un contacto directo con la población y escuchar sus problemas para generar un plan que los solucione y los apoye.
En el futuro, me gustaría trabajar en una ONG o crear una propia para ayudar a los que más lo necesitan y contribuir a la lucha por la justicia e igualdad social.
"""
...
texto_2 = """
. Recuerdo que, en mi primer día de clases, cuando me explicaron los temas que veríamos en el curso, me asusté porque no había tenido mucho contacto con la programación y nunca había usado Python. En la primera práctica, me fue muy mal, pero creo que eso fue lo que me impulsó a seguir aprendiendo y a esforzarme más. La programación me ha enseñado mucho; por ejemplo, que este sistema es más complejo de lo que parece, aunque constantemente se busca simplificarlo y hacerlo ver más sencillo.
Asimismo, la programación es muy importante en un mundo donde la cultura digital predomina cada día más. Lo que me gusta de programar es que me da la libertad de ser creativa en cuanto a los diseños gráficos, entre otros aspectos. Lo que no me gusta es que, al tener muchos códigos, a veces se me complica ejecutarlos de manera eficaz. En el futuro, me gustaría emplear lo aprendido en el curso para crear páginas donde pueda visibilizar las problemáticas en las que trabaje y así generar un mayor impacto en la sociedad, tal vez promoviendo la concientización y reflexión sobre estos temas a través de las páginas web y los datos que pueda colocar en ellas.
...
enlace = f'<a href="https://drive.google.com/file/d/1YcFD80Rmai505a4ynI8ZuZ0xnkXabIV3/view?usp=sharing" target="_blank"><button>Video de Cris</button></a>'
...
graficos = ['Nube de palabras de Alienación', 'Gráfico de barras de goles anotados']
...
if grafico_seleccionado == 'Nube de palabras de Alienación':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>En el primer gráfico, vemos una nube de palabras, que se utiliza para visualizar con mayor claridad la repetición de palabras: cuanto más grande es el tamaño de la palabra, es porque se repite muchas más veces que otras.</div>", unsafe_allow_html=True)
    sidebar.image("grafico 1.jpg", caption='Nube de palabras de Alienación', width=500)
    pass
elif grafico_seleccionado == 'Gráfico de barras de goles anotados':
    sidebar.markdown("<div style='text-align: justify'>En el segundo gráfico, podemos visualizar el número de goles que anotó cada equipo, tanto de local como de visitante. En este caso, el equipo que escogí fue Monza. Este gráfico de barras nos permite organizar mejor los datos de una gran base de datos y reducirlos a la información que queremos brindar.</div>", unsafe_allow_html=True)
    sidebar.image("grafico 2.jpg", caption='Gráfico de barras de goles anotados', width=500)
    pass
